...
| Deposit | Defaults to 0%; accepts an exact decimal; must be between 0 and 100 inclusive. | Exact parser, validation, persistence, and minimal create are implemented. | Live editor in Phase 2. |
