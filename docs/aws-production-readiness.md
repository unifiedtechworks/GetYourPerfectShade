...
11. Confirm `0001` through `0009` are applied with no mismatch or gap.
...
- [ ] Migrations `0001`–`0009`, initial owner bootstrap, and any separately approved additional
  owner provisioning are verified in production.
